...
character(40), dimension(2), parameter :: varlabel = ['landf' ,'frgPD']  !names of variables that will be automatically output, changed for compilation error by gfort, orignally 'foragerPD' - hiro, Dec. 2019
